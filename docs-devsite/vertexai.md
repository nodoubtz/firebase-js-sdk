...
|  [VertexAIOptions](./vertexai.vertexaioptions.md#vertexaioptions_interface) |  |
...
> 
> Use [getGenAI()](./vertexai.md#getgenai_65c48ee) instead. For example: `getGenAI(app, { backend: vertexAI() })`<!-- -->.
> 
...
> Warning: This API is now obsolete.
> 
> This is here to maintain backwards-compatibility. Use `GenAI` instead.
> 
